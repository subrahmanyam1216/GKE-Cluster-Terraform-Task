...
variable "network" {
  description = "A reference  to the VPC network to apply firewall rules to"
  type        = string
}

variable "public_subnetwork" {
  description = "A reference to the public subnetwork of the network"
  type        = string
}
...
variable "private_subnetwork" {
  description = "A reference  the private subnetwork of the network"
  type        = string
}
